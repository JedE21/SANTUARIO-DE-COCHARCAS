-- ============================================================================
-- 014 — FOOTER EDITABLE + REPARACIÓN DE SLIDES/NAVEGACIÓN
-- Santuario de Nuestra Señora de Cocharcas
--
-- 1) Nuevas columnas editables del footer (Configuración → Footer).
-- 2) Idempotencia total del CMS: si la base se creó con una migración antigua,
--    aquí se recrean tablas/policies que falten (slides, historia, enum de
--    secciones, etc.) para que el panel SÍ guarde los cambios.
-- 3) Ítem «Historia» en el menú (por si la 013 no se llegó a ejecutar).
--
-- Idempotente: puede ejecutarse varias veces sin daño.
-- ============================================================================

-- ---------------------------------------------------------------------------
-- 1. Footer: nuevas columnas editables
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2a. Enum slide_section: agregar secciones faltantes (idempotente)
-- ---------------------------------------------------------------------------
do $$ begin
...
-- con acceso a la tabla en algunas versiones: se hace uno por bloque.
do $$ begin
...
-- ---------------------------------------------------------------------------
-- 3. Datos semilla de slides (solo si la tabla quedó vacía)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4. Semilla de Historia (solo si las tablas quedaron vacías)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. Ítem «Historia» en el menú (por si la 013 no se ejecutó)
-- ---------------------------------------------------------------------------
